...
DATABASES = {
    'default': {
        ...
        'NAME': 'D:\Proyectos\Python\Django\DionaeaFR\logsql.sqlite', # Or path to database file if using sqlite3.
...
SECRET_KEY = 'o*w2sbrhel0^qx5dljbv6eyjwx)(76^wppdjrrxnj%wcny3h2r'
