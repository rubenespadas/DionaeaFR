...
class Connection(models.Model):
    ...
    connection_type = models.TextField(blank=True)
    connection_transport = models.TextField(blank=True)
    connection_protocol = models.TextField(blank=True)
    connection_timestamp = models.IntegerField(blank=True)
    connection_root = models.IntegerField(blank=True)
    connection_parent = models.IntegerField(blank=True)
    local_host = models.TextField(blank=True)
    local_port = models.IntegerField(blank=True)
    remote_host = models.TextField(blank=True)
    remote_hostname = models.TextField(blank=True)
    remote_port = models.IntegerField(blank=True)
    class Meta:
...
class Download(models.Model):
    download = models.IntegerField(primary_key=True, blank=True)
    connection = models.IntegerField(blank=True)
    download_url = models.TextField(blank=True)
    download_md5_hash = models.TextField(blank=True)
    class Meta:
